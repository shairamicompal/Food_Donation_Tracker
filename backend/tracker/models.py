...
#     pickup_option = models.CharField(max_length=50, choices=PICKUP_OPTIONS, blank=True, null=True)
#     notes = models.TextField(blank=True, null=True)
#     donation_type = models.CharField(max_length=10, choices=DONATION_TYPE_CHOICES)
#     created_at = models.DateTimeField(auto_now_add=True)
#     accepted = models.BooleanField(default=False)  # Later, organizations can accept donations
